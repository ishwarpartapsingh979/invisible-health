...
> **⚠️ READ `docs/strategy/CURRENT-STATE.md` FIRST — it is the canonical, up-to-date
> orientation** (product direction, the locked voice-first UX, the prioritised plan, the
> multi-user blocker, the mobile workflow) and it **supersedes older framing in this file**
> where they differ (notably: the product is now a **workout EXPERIENCE app**; **nutrition is
> PARKED**; fitness companion is the wedge). Update CURRENT-STATE.md at the end of each session.
